...
router.post('/properties', authVerify, validateProperty, createNewProperty);
...
router.patch('/properties/:id', authVerify, validateId, validatePropertyUpdate, updateProperty);
